...
export const mvpPhases: MvpPhase[] = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        status: "done",
        route: "/design-system",
        notes: "Hidden from nav — kept for internal reference at direct URL",
      },
      {
        id: "about",
        name: "About Page",
      ...
      {
        id: "project-images",
        name: "Project Photo Galleries",
        status: "in_progress",
        route: "/admin/projects",
        notes: "Up to 4 images per project — homepage featured gallery",
      },
      {
        id: "mvp-roadmap",
        name: "MVP Roadmap Page",
        status: "done",
        route: "/mvp",
        notes: "Hidden from public nav — internal direct URL only",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        notes: "Construction & Admin categories with role sub-types",
      },
      {
        id: "payroll",
        name: "Payroll Runs",
